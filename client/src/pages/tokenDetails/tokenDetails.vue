<template>
    <div class="container">
        <page-header :title="tokenDetails.name">
            <span slot>
               {{tokenDetails.name}} | {{tokenDetails.description}}
            </span>
        </page-header>
        <b-container>
                ...
                <div class="table-content">
                    <b-table class="tran-list" :fields="fields" :items="tx_list">
                        <template slot="tx_hash" slot-scope="data">
                            <router-link class="text-color" :to="'/translate-details/'+data.value">
                                {{data.value | shortHash}}
                            </router-link>
                        </template>
                        <template slot="block_height" slot-scope="data">
                            <router-link class="text-color" :to="'/block-details/'+data.value">{{data.value}}
                            </router-link>
                        </template>
