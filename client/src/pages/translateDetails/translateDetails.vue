      ...
      <b-row class="description">
        <b-col sm="6" cols="4" style="padding: 0">
          <div class="item first" style="padding-left: 15px">
            <h2>{{$t('height')}}</h2>
            <router-link class="text-color" :to="'/block-details/'+(txDetails.block_height || 0)">
              <span class="text-color">{{txDetails.block_height || 0}}</span>
            </router-link>
          </div>
        </b-col>
        <b-col sm="6" cols="4" style="padding: 0">
